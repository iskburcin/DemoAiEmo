...
class ActivityPage extends StatelessWidget {
  ...
  Future<void> _saveUserSelection(BuildContext context, String userId, String mood, String suggestion) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Failed to save selection. Status code: ${response.statusCode}, body: ${response.body}');
      }
    } catch (e) {
